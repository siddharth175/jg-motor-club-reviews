...
async function generateReview(service: string, experience: string) {
...
async function run() {
    console.log("--- Generating 5 reviews for 'Oil Change' ---");
    for (let i = 0; i < 5; i++) {
        console.log(`[${i + 1}] ${await generateReview("Oil Change", "The waiting room was clean.")}`);
        console.log("");
    }
}
